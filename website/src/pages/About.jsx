...
import pdf from '../assets/Sarah_Kwon_Resume.pdf';
import Footer from '../components/Footer';
const About = () => {
  return (
    <div className='w-full h-screen bg-white'>
        <div className='bg-image font-medium text-black subhead-text2 flex justify-center'>
          <div className='w-fit sm:mx-0 sm:ml-40 sm:mr-auto mt-24 '>
            <Fade> 
              <div>
                <h1>Hello, 👋 I'm</h1>  
              </div>
      ...
      <section className='max-container'>
        ...
        <Reveal>
          ...
          <Reveal>
          <p>Hi, I'm Dylan, a software engineering student studying at UNSW. I am passionate about design, full-stack development and also game development. 
